...
function node (files) {
  ...
  global._prova_includeFilenameAsPackage = command.includeFilenameAsPackage;
  global._prova_stopOnFirstFailure = command.stopOnFirstFailure;

  files.forEach(function (file) {
    global._prova_filename = file;
