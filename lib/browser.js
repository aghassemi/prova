...
function start (files, command) {
  ...
  function onMessage (msg) {
    ...
    if( msg.taprow && command.tap ) {
      process.stdout.write(msg.taprow);
    }
    ...
    if (msg.result) {
      ...
      if (command.quit) exit(msg.result.failed);
      return;
    }
...
function outputError (msg) {
  ...
  console.error(formatText(error.stack ? errorTemplate : errorNoStackTemplate, {
